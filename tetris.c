...
int main(void)
{
    ...
    while (kbhit() == 0) {
        ...
        gotoxy(0, 0); printf("¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã"); Sleep(100); if (kbhit()) break;
        gotoxy(0, 1); printf("¢Ã¡á¡á¡á¡à¡à¡à¡á¡á¡á¡à¡à¡à¡á¡á¡á¡à¡á¡á¡á¡á¢Ã"); Sleep(100); if (kbhit()) break;
        gotoxy(0, 2); printf("¢Ã¡à¡á¡à¡á¡á¡á¡à¡á¡à¡á¡á¡à¡à¡á¡à¡à¡á¡à¡à¡à¢Ã"); Sleep(100); if (kbhit()) break;
        gotoxy(0, 3); printf("¢Ã¡à¡á¡à¡á¡à¡à¡à¡á¡à¡á¡à¡á¡à¡á¡à¡à¡á¡á¡á¡á¢Ã"); Sleep(100); if (kbhit()) break;
        gotoxy(0, 4); printf("¢Ã¡à¡á¡à¡á¡á¡á¡à¡á¡à¡á¡á¡à¡á¡á¡á¡à¡à¡à¡à¡á¢Ã"); Sleep(100); if (kbhit()) break;
        gotoxy(0, 5); printf("¢Ã¡à¡à¡à¡á¡à¡à¡à¡à¡à¡á¡à¡á¡à¡à¡à¡à¡á¡á¡á¡á¢Ã"); Sleep(100); if (kbhit()) break;
        gotoxy(0, 6); printf("¢Ã¡à¡à¡à¡á¡á¡á¡à¡à¡à¡á¡à¡á¡à¡à¡à¡à¡à¡à¡à¡à¢Ã"); Sleep(100); if (kbhit()) break;
        gotoxy(0, 7); printf("¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã¢Ã"); Sleep(100); if (kbhit()) break;
        ...
        for (b = 0;; b++)
        {
            ...
            for (f = 0; f < 10 - level; f++)
            {
                ...
                else if (r1 == 1)
                {
                    ...
                    printf("¢Ã¢Ã");
                    gotoxy(34, 10); printf("  ¢Ã¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
                }
                else if (r1 == 4) {
                    SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 3);
                    printf("  ¢Ã");
                    gotoxy(34, 10); printf("¢Ã¢Ã¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
                }
                y = 0;
                Sleep(50);
                if (kbhit()) {
...
void reset_o(void) {
    if (x == 1) {
        ...
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 2); gotoxy(2 * c, b); printf("¢Ã");
        gotoxy(2 * c, (b + 1)); printf("¢Ã");
        gotoxy(2 * (c + 1), (b + 1)); printf("¢Ã");
        gotoxy(2 * (c + 2), (b + 1)); printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
    else if (x == 2) {
        a[b][c + 1] = 1;    a[b + 1][c + 1] = 1;    a[b + 2][c] = 1;    a[b + 2][c + 1] = 1;
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 2); gotoxy(2 * (c + 1), b); printf("¢Ã");
        gotoxy(2 * (c + 1), (b + 1));    printf("¢Ã");
        gotoxy(2 * (c + 1), (b + 2));    printf("¢Ã");
        gotoxy(2 * c, (b + 2));    printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
    else if (x == 3) {
        a[b][c] = 1;    a[b][c + 1] = 1;    a[b][c + 2] = 1;    a[b + 1][c + 2] = 1;
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 2); gotoxy(2 * (c + 1), b);    printf("¢Ã");
        gotoxy(2 * (c + 2), b);    printf("¢Ã");
        gotoxy(2 * c, b);    printf("¢Ã");
        gotoxy(2 * (c + 2), (b + 1));    printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
    else if (x == 4) {
        a[b][c] = 1;    a[b][c + 1] = 1;    a[b + 1][c] = 1;    a[b + 2][c] = 1;
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 2); gotoxy(2 * (c + 1), b);    printf("¢Ã");
        gotoxy(2 * (c), b + 2);    printf("¢Ã");
        gotoxy(2 * c, b);    printf("¢Ã");
        gotoxy(2 * (c), (b + 1));    printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
    else if (x == 5) {
        a[b][c] = 2;    a[b][c + 1] = 2;    a[b + 1][c] = 2;    a[b + 1][c + 1] = 2;
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 6); gotoxy(2 * (c + 1), b);    printf("¢Ã");
        gotoxy(2 * (c), b + 1);    printf("¢Ã");
        gotoxy(2 * c, b);    printf("¢Ã");
        gotoxy(2 * (c + 1), (b + 1));    printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
    else if (x == 6) {
        a[b][c] = 3;    a[b][c + 1] = 3;    a[b][c + 2] = 3;    a[b][c + 3] = 3;
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 1); gotoxy(2 * (c + 1), b);    printf("¢Ã");
        gotoxy(2 * (c + 2), b);    printf("¢Ã");
        gotoxy(2 * c, b);    printf("¢Ã");
        gotoxy(2 * (c + 3), (b));    printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
    else if (x == 7) {
        a[b + 1][c] = 3;    a[b + 2][c] = 3;    a[b + 3][c] = 3;    a[b][c] = 3;
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 1); gotoxy(2 * (c), b + 1);    printf("¢Ã");
        gotoxy(2 * (c), b);    printf("¢Ã");
        gotoxy(2 * c, b + 2);    printf("¢Ã");
        gotoxy(2 * (c), (b + 3));    printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
    else if (x == 8) {
        a[b][c] = 4;	a[b][c + 1] = 4;	a[b + 1][c + 1] = 4;	a[b + 1][c + 2] = 4;
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 5); gotoxy(2 * (c), b);    printf("¢Ã");
        gotoxy(2 * (c + 1), b + 1);    printf("¢Ã");
        gotoxy(2 * (c + 1), b);    printf("¢Ã");
        gotoxy(2 * (c + 2), (b + 1));    printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
    else if (x == 9) {
        a[b][c + 1] = 4;	a[b + 1][c + 1] = 4;	a[b + 1][c] = 4;	a[b + 2][c] = 4;
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 5); gotoxy(2 * (c), b + 2);    printf("¢Ã");
        gotoxy(2 * (c), b + 1);    printf("¢Ã");
        gotoxy(2 * (c + 1), b);    printf("¢Ã");
        gotoxy(2 * (c + 1), (b + 1));    printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
        ...
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 3); gotoxy(2 * (c + 1), b); printf("¢Ã");
        gotoxy(2 * c, b + 1); printf("¢Ã");
        gotoxy(2 * (c + 1), b + 1); printf("¢Ã");
        gotoxy(2 * (c + 2), b + 1); printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
        ...
        gotoxy(2 * (c + 1), b + 1); printf("¢Ã");
        gotoxy(2 * (c), b + 1); printf("¢Ã");
        gotoxy(2 * (c + 1), b + 2); printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
    else if (x == 12) {
        a[b][c] = 5;	a[b][c + 1] = 5;	a[b][c + 2] = 5;	a[b + 1][c + 1] = 5;
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 3); gotoxy(2 * (c), b); printf("¢Ã");
        gotoxy(2 * (c + 1), b); printf("¢Ã");
        gotoxy(2 * (c + 2), b); printf("¢Ã");
        gotoxy(2 * (c + 1), b + 1); printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
        ...
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 3); gotoxy(2 * c, b); printf("¢Ã"); gotoxy(2 * c, b + 1); printf("¢Ã"); gotoxy(2 * (c + 1), b + 1); printf("¢Ã"); gotoxy(2 * c, b + 2); printf("¢Ã"); SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    }
    return;
}
...
void check_clear(void)
{
    ...
    for (m = b + j - 1; m >= b - 1; m--)
        ...
        {
            gotoxy(2, m); printf("¡Ú¡Ú¡Ú¡Ú¡Ú¡Ú¡Ú¡Ú¡Ú¡Ú");
            n++;
        }
    for (m = b + j - 1; m >= b - 1; m--)
        if (a[m][1] != 0 && a[m][2] != 0 && a[m][3] != 0 && a[m][4] != 0 && a[m][5] != 0 && a[m][6] != 0 && a[m][7] != 0 && a[m][8] != 0 && a[m][9] != 0 && a[m][10] != 0) {
...
{
    SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 7);
    gotoxy(0, 6); printf("¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç");
    gotoxy(0, 7); printf("¢Ç                              ¢Ç");
    gotoxy(0, 8); printf("¢Ç  +-----------------------+   ¢Ç");
    gotoxy(0, 9); printf("¢Ç  |  G A M E  O V E R..   |   ¢Ç");
    gotoxy(0, 10); printf("¢Ç  +-----------------------+   ¢Ç");
    gotoxy(0, 11); printf("¢Ç   YOUR SCORE: %6d         ¢Ç", score);
    gotoxy(0, 12); printf("¢Ç                              ¢Ç");
    fileopen_wt();
    gotoxy(0, 14); printf("¢Ç                              ¢Ç");
    gotoxy(0, 15); printf("¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç");
    return;
}
...
void pause_p(void)
{
    ...
    gotoxy(0, 7); printf("¢Ç                              ¢Ç");
    gotoxy(0, 8); printf("¢Ç  +-----------------------+   ¢Ç");
    gotoxy(0, 9); printf("¢Ç  |	     PAUSED..       |   ¢Ç");
    gotoxy(0, 10); printf("¢Ç  +-----------------------+   ¢Ç");
    gotoxy(0, 11); printf("¢Ç                              ¢Ç");
    gotoxy(0, 12); printf("¢Ç                              ¢Ç");
    gotoxy(0, 13); printf("¢Ç     Press \'c\' to resume..    ¢Ç");
    gotoxy(0, 14); printf("¢Ç                              ¢Ç");
    gotoxy(0, 15); printf("¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç¢Ç");
    Sleep(100);
WAIT:
...
void fileopen_wt(void) {
    if (score > bestscore) {
        ...
        gotoxy(0, 13); printf("¢Ç  ¡Ú¡Ú¡Ú BEST SCORE! ¡Ú¡Ú¡Ú   ¢Ç");
        fprintf(file, "%d", score);
        fclose(file);
    }
    else
        gotoxy(0, 13); printf("¢Ç                              ¢Ç");
    return;
}